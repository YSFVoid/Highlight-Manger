...
def warm_card_assets(default_prefix: str = "!") -> None:
    _font(FONT_REGULAR_CANDIDATES, 18)
    _font(FONT_REGULAR_CANDIDATES, 24)
    _font(FONT_BOLD_CANDIDATES, 24)
    _font(FONT_BOLD_CANDIDATES, 34)
    _font(FONT_TITLE_CANDIDATES, 46)
    render_help_banner(default_prefix)
