...
def build_match_embed(match: MatchRecord, guild: discord.Guild | None) -> discord.Embed:
    ...
    embed.add_field(name="Queue Expires", value=format_relative(match.queue_expires_at), inline=True)
    embed.add_field(
        name="Vote Deadline",
...
def build_config_embed(config: GuildConfig, guild: discord.Guild | None) -> discord.Embed:
    ...
    embed.add_field(name="Apostado Play Room", value=_channel_label(guild, config.apostado_play_channel_id), inline=True)
    embed.add_field(name="Highlight Play Room", value=_channel_label(guild, config.highlight_play_channel_id), inline=True)
